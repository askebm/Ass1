...
\begin{frame}[t]{RGB}{Defines}
	\lstinputlisting[firstline=25, lastline=33]{../src/rgb.h}
\end{frame}

\begin{frame}[t]{RGB}{Function interfaces}
	\lstinputlisting[firstline=39, lastline=52]{../src/rgb.h}
\end{frame}

\begin{frame}[t]{RGB}{rgb\_set\_color}
	\lstinputlisting[firstline=32, lastline=41]{../src/rgb.c}
\end{frame}
...
\begin{frame}[t]{Switch 1}{Function interfaces}
	\lstinputlisting[firstline=31, lastline=41]{../src/sw1.h}
\end{frame}
...
\begin{frame}[t]{System Timer}{Function interfaces}
	\only<1>{
	\lstinputlisting[firstline=30, lastline=43]{../src/timer.h}
	}
	\only<2>{
	\lstinputlisting[firstline=44, lastline=50]{../src/timer.h}
	}
\end{frame}
...
\begin{frame}[t]{Main}{Defines}
	\lstinputlisting[firstline=28, lastline=35]{../src/main.c}
\end{frame}
...
\begin{frame}[t]{Main}{Helper function}
	\lstinputlisting[firstline=55, lastline=74]{../src/main.c}
\end{frame}

\subsection{Debounce}%
\label{sub:debounce}
\begin{frame}[t]{Main}{debounce}
	\lstinputlisting[firstline=99, lastline=107]{../src/main.c}
\end{frame}
...
\begin{frame}[t]{States}{Valid click}
	\only<1>{
	\lstinputlisting[firstline=109, lastline=124]{../src/main.c}
	}
	\only<2>{
	\lstinputlisting[firstline=125, lastline=138]{../src/main.c}
	}
\end{frame}

\begin{frame}[t]{States}{Auto}
	\lstinputlisting[firstline=139, lastline=142]{../src/main.c}
\end{frame}
